...
{
    public event EventHandler<IHasProgress.OnProgressChangedEvevtArgs> OnProgressChanged;
    ...
    private void Update()
    {
        switch (state)
        {
            ...
            case State.Frying:
                ...
                OnProgressChanged?.Invoke(this, new IHasProgress.OnProgressChangedEvevtArgs
                {
